...
export default function Overview() {
  ...
  const prodById = useMemo(() => {
    ...
    const deliveredLastMonth = orders.filter(

      (o) => o.status === "entregue" && o.deliveredAt && monthKey(o.deliveredAt) === lastMonthKey

    );

    const salesLastMonth = deliveredLastMonth.reduce((acc, o) => {
    ...
    const salesPercentageChange = salesLastMonth > 0 ? ((salesThisMonth - salesLastMonth) / salesLastMonth) * 100 : salesThisMonth > 0 ? 100 : 0;
      ...
      <div translate="no" style={{ fontFamily: "'DM Sans','Segoe UI',sans-serif", display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(220px,1fr))", gap: 16 }}>
          ...
          <StatCard
            ...
            badge={`${salesPercentageChange >= 0 ? "+" : ""}${salesPercentageChange.toFixed(2)}%`}
